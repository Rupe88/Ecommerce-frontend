const Card = () => {
  return (
    <div className="max-w-[1240px] mx-auto">
        <h1 className="text-2xl mt-5">Top Products 😁</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {[...Array(8)].map((_, index) => (
          <div
            key={index}
            className="group my-10 w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md mx-auto"
          >
            <a
